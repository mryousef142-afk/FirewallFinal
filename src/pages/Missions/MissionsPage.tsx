...
const MISSIONS: Record<MissionCategory, Mission[]> = {
  ...
  monthly: [
    ...
    },
    {
      ...
      description: "Spend your XP in the marketplace on credits or badges.",
      xp: 170,
      icon: "trophy",
    },
  ],
...
const REWARDS: Reward[] = [
  {
    id: "reward-credit-7",
    title: "7-day free credit",
    cost: 800,
    description: "Instantly extend any group by a full week at no cost.",
  },
  {
    id: "reward-credit-14",
    title: "14-day free credit",
    cost: 1400,
    description: "Add two weeks of uptime to keep your community thriving.",
  },
  {
    id: "reward-credit-30",
    title: "30-day free credit",
    cost: 2500,
    description: "A full month of protection for your most active group.",
  },
  {
    id: "badge-rookie",
    title: "🌟 Rookie Badge",
    cost: 200,
    description: "Show everyone you're taking the first steps in mastery.",
  },
  {
    id: "badge-active",
    title: "⚡ Active Member Badge",
    cost: 500,
    description: "Prove your dedication with this exclusive community badge.",
  },
  {
    id: "badge-master",
    title: "🎯 Mission Master Badge",
    cost: 1000,
    description: "Reserved for those who complete missions consistently.",
  },
  {
    id: "badge-elite",
    title: "💎 Elite Guardian Badge",
    cost: 2000,
    description: "An ultra-rare badge for the most committed protectors.",
  },
  {
    id: "badge-legend",
    title: "👑 Legend Badge",
    cost: 5000,
    description: "The ultimate achievement - only legends reach this level.",
  },
];
