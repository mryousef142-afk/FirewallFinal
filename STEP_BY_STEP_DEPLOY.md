# 🚀 راهنمای گام به گام: راه‌اندازی ربات تلگرام با Cloudflare
...
## ☁️ مرحله 4: راه‌اندازی Cloudflare Account

### گام 4.1: ساخت حساب Cloudflare
1. به آدرس بروید: https://dash.cloudflare.com/sign-up
2. ایمیل و رمز عبور وارد کنید
3. ایمیل خود را تایید کنید

### گام 4.2: ورود به Dashboard
1. به https://dash.cloudflare.com بروید
2. Login کنید

**✅ حالا حساب Cloudflare شما آماده است!**

---

## 🗄️ مرحله 5: راه‌اندازی دیتابیس با Neon (رایگان)

**⚠️ نکته: این پروژه از PostgreSQL استفاده می‌کند، نه Cloudflare D1**

### گام 5.1: ساخت حساب Neon
1. به آدرس بروید: https://neon.tech
2. روی "Sign Up" کلیک کنید
3. با GitHub خود Login کنید (راحت‌تر است)

### گام 5.2: ساخت پروژه جدید
1. روی "Create Project" کلیک کنید
2. نام پروژه: `firewall-bot` (یا هر نام دیگری)
3. Region: انتخاب کنید (مثلاً US East)
4. روی "Create Project" کلیک کنید

### گام 5.3: دریافت Connection String
پس از ساخت پروژه، یک صفحه باز می‌شود که می‌گوید:
...
**🔴 مهم: این Connection String را کپی کنید!**

مثال:
```
postgresql://alex:abc123xyz@ep-cool-waterfall-123456.us-east-2.aws.neon.tech/neondb?sslmode=require
```
